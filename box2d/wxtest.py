...
class GLCanvas(WxCanvas):
    def __init__(self, parent, id=-1, config=None, context=None):
        WxCanvas.__init__(self, parent, id, config, context)

        self.label = pyglet.text.Label('Hello, world', font_size=48,
    ...
    def MouseDown(self, evt):
        self.label = pyglet.text.Label('AAAAAAAAAAAAAAAAAAAA', font_size=48,
                              anchor_x='center', anchor_y='center')
...
class MyApp(wx.App):
    def OnInit(self):
        frame = MyFrame(None, 'Testing wxPython + pyglet')
